...
public class QueryEmpleado {
    ...
    public void Agregar( String rfc,String nombre,String clave_ser,String curp,String domicilio,
        ...
        try{
            ...
            String sql="INSERT INTO Datos_Generales "
                    + "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            pst.setString(3,clave_ser);
            pst.setString(4, curp);
            pst.setString(5,domicilio);
            pst.setString(6,localidad);
            pst.setString(7, municipio);
            pst.setString(8, cp);
            pst.setString(9, estado_c);
            pst.setString(10,lugar_n);
            pst.setString(11, correo);
            pst.setString(12, tel_part);
            pst.setString(13, tel_c);
            pst.setString(14, tel_lab);
